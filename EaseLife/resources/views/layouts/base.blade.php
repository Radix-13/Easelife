                        ...
                        <ul class="contact_footer">
                            ...
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@EaseLife.bd">contact@EaseLife.bd</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+8801869326580">+8801869326580</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+8801869326580">+8801869326580</a>
                            </li>
                        </ul>
